...
class PlaneBookingPage extends StatefulWidget {
  final int pid;
  PlaneBookingPage({required this.pid});

  @override
  State<PlaneBookingPage> createState() => _PlaneBookingPageState();
}

class _PlaneBookingPageState extends State<PlaneBookingPage> {
          ...
          child: Column(
            children: [
              ...
              ElevatedButton(
                ...
                child: const Text('Search Available Flights'),
              ),
              const SizedBox(height: 20),
              buildVehicleList(),
            ],
